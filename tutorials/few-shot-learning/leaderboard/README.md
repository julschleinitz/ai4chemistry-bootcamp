...
leaderboard challenge in `few-shot-learning.ipynb`. It follows the exact same pattern as
`tutorials/neural-networks-mlp/leaderboard/`: a fixed split published in advance, and a
