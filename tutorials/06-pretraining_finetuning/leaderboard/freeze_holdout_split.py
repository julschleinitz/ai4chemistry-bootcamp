...
this bootcamp (see tutorials/04-deep-learning-neural-network/neural-networks-mlp/README.md): the instructor publishes one split
...
N_MAX = 40  # keep in sync with pretraining_finetuning.ipynb
